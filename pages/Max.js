            ...
            <div className="flex flex-col md:flex-row items-center justify-between p-10 relative z-10 md:ml-96">
              <div className="max-w-lg">
                <h1 className="text-5xl font-bold mb-4">
                  Virtual reality <br></br> glasses: <span className="text-purple-400">Max</span>
                </h1>
                <p className="mb-8">
              ...
              <div className=" mt-0 h-20 max-md:h-32 md:mr-96">
                ...
                <img src="./Max.png" alt="VR Glasses" className="w-full max-w-sm animate-[bounces_4s_ease-in-out_infinite]" />
